---
title: "Introduction to refbrown through Examples"
author: Yingfa Xie
date: "`r Sys.Date()`"
output:
  rmarkdown::html_document:
    ...
    toc_depth: 2
    toc_float: true
bibliography: ../inst/bib/refbrown.bib
vignette: >
  %\VignetteIndexEntry{Introduction to refbrown through Examples}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

In this vignettes, we briefly introduce how to explore recurrent event data by 
first hitting time model of reflected Brownian motion (RBM) with the **refbrown** 
package. The **refbrown** package implements the density, distribution, quantile, 
...
in **refbrown** can be used for simulating recurrent event (gap) times. 
